...
# ) -> Intersection:
#     """Calculates intersection coordinates of line with bounding box, from point_a to point_b."""
#     point_a, point_b = coordinates
#     slope = calculate_gradient(point_a=point_a, point_b=point_b)
...
#     c_constant = point_a[1] - slope * point_a[0]

#     # check intersection with each side of the bounding box
#     # left side (x = xmin)
#     y = slope * bounding_box.xmin + c_constant
...
#     # right side (x = xmax)
#     y = slope * bounding_box.xmax + c_constant
#     if bounding_box.ymin <= y <= bounding_box.ymax:
#         intersections.append(
...
#     # bottom side (y = ymin)
#     x = (bounding_box.ymin - c_constant) / slope
...
#     # top side (y = ymax)
#     x = (bounding_box.ymax - c_constant) / slope
#     if bounding_box.xmin <= x <= bounding_box.xmax:
#         intersections.append(
